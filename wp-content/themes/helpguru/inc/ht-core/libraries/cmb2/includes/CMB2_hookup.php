	...
	public static function register_scripts() {
		...
		if ( ! is_admin() ) {
			...
			wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
				'clear'         => __( 'Clear', 'cmb2', 'helpguru' ),
				'defaultString' => __( 'Default', 'cmb2', 'helpguru' ),
				'pick'          => __( 'Select Color', 'cmb2', 'helpguru' ),
				'current'       => __( 'Current Color', 'cmb2', 'helpguru' ),
			) );
		}
		...
		wp_localize_script( 'cmb2-scripts', 'cmb2_l10', apply_filters( 'cmb2_localized_data', array(
			...
			'defaults'         => array(
				...
				'date_picker'  => array(
					'changeMonth'     => true,
					'changeYear'      => true,
					'dateFormat'      => __( 'mm/dd/yy', 'cmb2', 'helpguru' ),
					'dayNames'        => explode( ',', __( 'Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday', 'cmb2', 'helpguru' ) ),
					'dayNamesMin'     => explode( ',', __( 'Su, Mo, Tu, We, Th, Fr, Sa', 'cmb2', 'helpguru' ) ),
					'dayNamesShort'   => explode( ',', __( 'Sun, Mon, Tue, Wed, Thu, Fri, Sat', 'cmb2', 'helpguru' ) ),
					'monthNames'      => explode( ',', __( 'January, February, March, April, May, June, July, August, September, October, November, December', 'cmb2', 'helpguru' ) ),
					'monthNamesShort' => explode( ',', __( 'Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec', 'cmb2', 'helpguru' ) ),
					'nextText'        => __( 'Next', 'cmb2', 'helpguru' ),
					'prevText'        => __( 'Prev', 'cmb2', 'helpguru' ),
					'currentText'     => __( 'Today', 'cmb2', 'helpguru' ),
					'closeText'       => __( 'Done', 'cmb2', 'helpguru' ),
					'clearText'       => __( 'Clear', 'cmb2', 'helpguru' ),
				),
				'time_picker'  => array(
					'startTime'   => '00:00',
					'endTime'     => '23:59',
			...
			'strings' => array(
				'upload_file'  => __( 'Use this file', 'cmb2', 'helpguru' ),
				'remove_image' => __( 'Remove Image', 'cmb2', 'helpguru' ),
				'remove_file'  => __( 'Remove', 'cmb2', 'helpguru' ),
				'file'         => __( 'File:', 'cmb2', 'helpguru' ),
				'download'     => __( 'Download', 'cmb2', 'helpguru' ),
				'check_toggle' => __( 'Select / Deselect All', 'cmb2', 'helpguru' ),
			),
		) ) );
