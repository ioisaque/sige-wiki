					...
					<div class="cmb-tbody cmb-field-list">
						<div class="cmb-row cmb-repeat-row">
							...
							<div class="cmb-td cmb-remove-row">
								<a class="button cmb-remove-row-button button-disabled" href="#">'. __( 'Remove', 'cmb2', 'helpguru' ) .'</a>
							</div>
						</div>
						<div class="cmb-row empty-row hidden">
							...
							<div class="cmb-td cmb-remove-row">
								<a class="button cmb-remove-row-button" href="#">'. __( 'Remove', 'cmb2', 'helpguru' ) .'</a>
							</div>
						</div>
					</div>
				</div>
