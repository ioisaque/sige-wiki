...
add_filter('hkb_analytics_supported', '__return_false');
    ...
    ## Insere o CSS da logo da pagina de login ##
	function imagem_login() {
	  echo '<style type="text/css">'
		  .'.login a img { width: 250px;'
		  .'display: block; margin: 0 auto;}'
		  .'</style>';
	}
	add_action('login_head', 'imagem_login');
	#FIM
	
	## Muda a página de redirecionamento depois do login ##
	function admin_default_page() {
		return home_url().'/?post_type=ht_kb';
	}
