    ...
    <ul class="hkb-subcats">
        <?php foreach ($subcategories as $term): ?>
            <li class="hkb-subcats__cat">
                ...
                <a class="hkb-subcats__cat-title" href="<?php echo esc_attr(get_term_link($term, 'ht_kb_category')); ?>" title="<?php echo sprintf( __( 'View all posts in %s', 'helpguru' ), $term->name ); ?>" ><?php echo $term->name; ?></a>
